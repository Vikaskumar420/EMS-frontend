...
const AddDepartment = () => {
    ...
    const handleSubmit= async (e)=>{
        e.preventDefault()
        try{
            const response = await axios.post("https://ems-server-bnxh.onrender.com/api/department/add", department,{
                headers:{
    ...
    return (
        ...
        <div className='max-w-3xl mx-auto mt-10 bg-white p-8 rounded-md shadow-md hover:shadow-black w-96'>
